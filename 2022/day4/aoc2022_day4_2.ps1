...
foreach($line in Get-Content $file) {
    ...
    if((($value_pair1_a -ge $value_pair2_a) -and ($value_pair1_a -lt $value_pair2_b)) -or (($value_pair1_b -le $value_pair2_b) -and ($value_pair1_b -ge $value_pair2_a))){
        $count +=1
        Write-Host "    $($line)"
        continue
    } elseif ((($value_pair2_a -ge $value_pair1_a) -and ($value_pair2_a -lt $value_pair1_b)) -or (($value_pair2_b -le $value_pair1_b) -and ($value_pair2_b -ge $value_pair1_a))) {
        $count +=1
        Write-Host "    $($line)"
        continue
    }
